...
class LocationCharacter(db.Model):
    ...
    team_color = db.Column(db.String(16), nullable=True)
    ...
    grapple_target_id = db.Column(db.Integer, nullable=True)
    grappled_by_id = db.Column(db.Integer, nullable=True)
    grapple_strengthened = db.Column(db.Boolean, nullable=False, default=False)
    grapple_choke_rounds = db.Column(db.Integer, nullable=False, default=0)
    grapple_live_shield = db.Column(db.Boolean, nullable=False, default=False)
